...
public final class RabbitWorkerQueue implements ManagedWorkerQueue
{
    ...
    private final InProgressTasks inProgressTasks = new InProgressTasks();
        ...
        throws QueueException
    {
        ...
        // Hook the worker callback so that the in-progress task list is automatically updated
        callback = inProgressTasks.hookTaskCallback(callback);
    ...
    ) throws QueueException
    {
        ...
        final MyTask acknowledgeTask = inProgressTasks.retrieve(acknowledgeId, isFinalResponse);
        acknowledgeTask.incrementResponseCount(isFinalResponse);
    ...
    public void rejectTask(String messageId)
    {
        ...
        inProgressTasks.remove(messageId);
    ...
    {
        Objects.requireNonNull(messageId);
        if (inProgressTasks.retrieve(messageId, true).finalizeResponseCount()) {
